...
urlpatterns = [
    ...
    path('student/register/by_user/', views.add_student_by_user, name='add_student_by_user'),
    path('add_student_from_slider/', views.add_student_from_slider, name='add_student_from_slider'),
